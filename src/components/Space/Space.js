...
export default function Space() {
    ...
    return (
        <div style={{ display: "flex", justifyContent: "center", marginLeft: "15%", position: "relative" }}>
            <div style={{ flexDirection: "column", width: "100%" }}>
                <section className={darkMode ? "MainDark AddquestinHome" : "Main AddquestinHome"} style={{ color: darkMode ? "#d1d6d6" : "black" ,height:"auto"}} id="spaceimage">
                    <section>
          ...
          space.map((post, index) => {
            ...
            <section className="advertisementContainer invitesection" style={{ background: darkMode ? "#262626" : "#fff", color: darkMode ? "#b0b2b5" : "#848485", position: "relative" }}>
